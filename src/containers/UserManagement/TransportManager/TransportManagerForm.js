...
class TransportManagerForm extends React.Component {


  componentDidMount() {
  	openTab('transportManager_tab');
  }
  ...
  <br />
    <div class="page-header">
     <Link to="/TransportManager_list" class="btn btn-primary"> View Transport Manager Data </Link>
    </div>
     <div class="card">
        <br />
        <div class="tab">
            <button class="tablinks active" id="btn_transportManager_tab" onClick={ () => openTab('transportManager_tab')}>PERSONAL DETAILS</button>
            <button class="tablinks" id="btn_edu_tab"  onClick={ () => openTab('edu_tab')}>EDUCATIONAL DETAILS</button>
        </div>

        <div id="logbox">
            <form >
                <div id="transportManager_tab" class="tabcontent">
                ...
                <div id="edu_tab" class="tabcontent">
                    ...
                    <button class="btn btn-primary" onClick={ () => openTab('transportManager_tab')}> Previous Step - Fill Personal Details </button>
                    <div class="sbt_btn">
                        <button class="btn btn-primary" type="submit">Save Transport Manager Data</button>
                    </div>
                </div>
            </form>
        </div>
...
export default TransportManagerForm;