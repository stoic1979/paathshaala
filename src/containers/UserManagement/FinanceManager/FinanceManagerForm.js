...
class FinanceManagerForm extends React.Component {


  componentDidMount() {
  	openTab('financeManager_tab');
  }
  ...
  <br />
    <div class="page-header">
     <Link to="/FinanceManager_list" class="btn btn-primary"> View Finance Manager Data </Link>
    </div>
     <div class="card">
        <br />
        <div class="tab">
            <button class="tablinks active" id="btn_financeManager_tab" onClick={ () => openTab('financeManager_tab')}>PERSONAL DETAILS</button>
            <button class="tablinks" id="btn_edu_tab"  onClick={ () => openTab('edu_tab')}>EDUCATIONAL DETAILS</button>
        </div>

        <div id="logbox">
            <form >
                <div id="financeManager_tab" class="tabcontent">
                ...
                <div id="edu_tab" class="tabcontent">
                    ...
                    <button class="btn btn-primary" onClick={ () => openTab('financeManager_tab')}> Previous Step - Fill Personal Details </button>
                    <div class="sbt_btn">
                        <button class="btn btn-primary" type="submit">Save Finance Manager Data</button>
                    </div>
                </div>
            </form>
        </div>
