...
class CounsellorForm extends React.Component {


  componentDidMount() {
    console.log("openTab counsellor_tab");
  	openTab('counsellor_tab');
  }
  ...
  <br />
    <div class="page-header">
     <Link to="/Counsellor_list" class="btn btn-primary"> View Counsellor Data </Link>
    </div>
     <div class="card">
        <br />
        <div class="tab">
            <button class="tablinks active" id="btn_counsellor_tab" onClick={ () => openTab('counsellor_tab')}>PERSONAL DETAILS</button>
            <button class="tablinks" id="btn_edu_tab"  onClick={ () => openTab('edu_tab')}>EDUCATIONAL DETAILS</button>
        </div>

        <div id="logbox">
            <form >
                <div id="counsellor_tab" class="tabcontent">
                ...
                <div id="edu_tab" class="tabcontent">
                    ...
                    <button class="btn btn-primary" onClick={ () => openTab('counsellor_tab')}> Previous Step - Fill Personal Details </button>
                    <div class="sbt_btn">
                        <button class="btn btn-primary" type="submit">Save Counsellor Data</button>
                    </div>
                </div>
            </form>
        </div>
