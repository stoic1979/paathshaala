...
class TeacherForm extends React.Component {
  ...
  render() {
    ...
    <div class="page-header">
        <Link to="/Teacher_list" class="btn btn-primary"> View All Teachers </Link>
    </div>
    <br />
    <div class="card">
        <br />
        <div class="tab">
            <button class="tablinks active" id="btn_teacher_tab" onClick={ () => openTab('teacher_tab')}>PERSONAL DETAILS</button>
            <button class="tablinks" id="btn_edu_tab"  onClick={ () => openTab('edu_tab')}>EDUCATIONAL DETAILS</button>
        </div>

        <div id="logbox">
            <form >
                <div id="teacher_tab" class="tabcontent">
                ...
                <div id="edu_tab" class="tabcontent">
                    ...
                    <button class="btn btn-primary" onClick={ () => openTab('teacher_tab')}> Previous Step - Fill Personal Details </button>
                    <div class="sbt_btn">
                        <button class="btn btn-primary" type="submit">Save Teacher Data</button>
                    </div>
                </div>
            </form>
        </div>
